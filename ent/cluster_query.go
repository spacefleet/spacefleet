...
func (_q *ClusterQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ClusterQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *ClusterQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *ClusterQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *ClusterQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *ClusterQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(cluster.FieldOrganizationID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Cluster.Query().
//		Select(cluster.FieldOrganizationID).
//		Scan(ctx, &v)
...
func (_q *ClusterQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withOrganization != nil {
			_spec.Node.AddColumnOnce(cluster.FieldOrganizationID)
		}
	}
